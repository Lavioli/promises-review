...
* Inside the callback from your get related artists request, loop through each artist and make a request to the [top tracks endpoint](https://developer.spotify.com/web-api/get-artists-top-tracks/).
